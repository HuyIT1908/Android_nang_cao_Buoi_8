...
public class MainActivity extends AppCompatActivity {
    ...
    public void open_camera_Intent(View view){
//        1 . xin quyen
//        2. khoi tao call back, start camera Intent
...
//        3. hien thi anh thumbnail xem tren truoc trong ham onActivityResult
//        4. tuy chon luu anh goc
...
//            quet lai thu vien
    ...
    public void change_camera_api(View view){
        startActivity(new Intent(this , Camera_apiActivity.class));
    }
}